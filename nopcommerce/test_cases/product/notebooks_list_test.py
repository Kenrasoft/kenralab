from page_objects.product.notebooks_list_page import NotebooksListPage
from test_cases.base_test import BaseTest
import time
import re

class TestNotebooksListPage (BaseTest):
    def test_camera_list_navigation(self, browser):
        camera_list_page = NotebooksListPage(browser)       
        page_title=camera_list_page.navigate_to_product_page()  
        time.sleep(5)
        print (page_title)
        assert page_title=="Notebooks"
