...
from pulse.fmpapi.get_api import Prices
...
from pulse.repository.stock_prices import Prices_table
...
# Mainly focus on loading all the index companies from SP500, NASDAQ and DOWJONES
    ...
    def load_index_companies():
        ...
        prices_api = Prices()
        prices_json_data = prices_api.fetch()
        print("Fetched price json data from API")

        prices_repo = Prices_table()
        prices_repo.load_data(prices_json_data)
